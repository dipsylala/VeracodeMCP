...
export class VeracodeDirectClient {
    private veracodeClient: VeracodeClient;
    private toolRegistry: ToolRegistry;

    constructor() {
        logger.debug('Initializing VeracodeDirectClient', 'CLIENT');
        ...
        logger.info('VeracodeDirectClient initialized successfully', 'CLIENT');
    }
