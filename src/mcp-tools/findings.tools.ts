...

  {
    ...
    schema: {
      ...
      scan_type: z
        ...
        .optional()
        .describe('Type of scan findings to retrieve'),
      ...
      include_expiration_date: z
        .boolean()
        .optional()
        .describe('Include grace period expiration dates (default: false)'),
      new_findings_only: z.boolean().optional().describe('Only show new findings (default: false)'),
      sca_dependency_mode: z
        .enum(['UNKNOWN', 'DIRECT', 'TRANSITIVE', 'BOTH'])
        .optional()
        .describe('SCA dependency mode filter'),
