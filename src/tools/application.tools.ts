...
const GetApplicationProfileDetailsScheme = z.object({
...
type SearchApplicationsArgs = z.infer<typeof SearchApplicationsSchema>;
type GetApplicationProfileDetailsArgs = z.infer<typeof GetApplicationProfileDetailsScheme>;
